...
<aside class="control-sidebar control-sidebar-dark">
    ...
    <ul class="nav nav-tabs nav-justified control-sidebar-tabs">
        <li class="nav-item"><a href="#control-sidebar-home-tab" data-toggle="tab" class="nav-link"><i class="fa fa-home"></i></a>
        </li>
        <li class="nav-item"><a href="#control-sidebar-settings-tab" data-toggle="tab" class="nav-link"><i class="fa fa-gears"></i></a>
        </li>
    </ul>
    <!-- Tab panes -->
    <div class="tab-content">
        ...
        <div class="tab-pane" id="control-sidebar-settings-tab">
            <form method="post">
                ...
                <!-- /.form-group -->
                <div class="form-group">
                    <label class="control-sidebar-subheading">Delete chat history <a href="javascript:void(0)" class="text-red float-right"><i class="fa fa-trash-o"></i></a>
                    </label>
                </div>
                <!-- /.form-group -->
            </form>
