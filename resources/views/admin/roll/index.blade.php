                        ...
                        <div class="card card-success">
                            <div class="card-header">
                                <h3 class="card-title">Manage Admin User
                                    <a class="pull-right" href="{{url('admin/managers')}}"><div class="btn btn-info btn-sm">New</div></a>
                                </h3>
                            </div>
                            <!-- /.card-header -->
                            <div class="card-body">
                                    ...
                                    @foreach($admin_user as $row)
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <td>
                                                    <a href="{{url('admin/managers/'.$row->id.'/edit')}}" title="Assign roll"><div class="btn btn-secondary btn-sm"><i class="fa fa-key"></i></div></a>
                                                    <a href="{{url('admin/managers/'.$row->id.'/edit')}}" title="Edit manager"><div class="btn btn-warning btn-sm"><i class="fa fa-edit"></i></div></a>
                                                    @if($row->id != 1)
                                                        <a href="{{url('admin/managers/'.$row->id.'/delete')}}" title="Delete manager"><div class="btn btn-danger btn-sm"><i class="fa fa-trash"></i></div></a>
                                                    @endif
